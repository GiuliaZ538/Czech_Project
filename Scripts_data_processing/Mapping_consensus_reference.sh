...
#Checking tree of the reference
...
echo $bname
echo $bname2
/rename.sh in=$bname out=$bname.fasta prefix=$bname2
done

6. ###Alignment and Tree building with RAXML-NG
cat *consensus.fasta Ref_not_aligned.fa > Allref_mycons.fa

mafft --thread 40 --leavegappyregion Alignment_reads.fa > Alignment_aligned.fa

raxml-ng --search1 --msa Alignment_aligned.fa --model GTR+G --prefix Name_file_output --threads 2 --seed 2 
